...
public class RoundImageView extends AppCompatImageView {
    ...
    public static final int TYPE_ROUND_Fix = 2;
    /**
     * 圆角大小的默认值
     */
                ...
                R.styleable.RoundImageView_borderRadius, (int) TypedValue
                        .applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                BODER_RADIUS_DEFAULT, getResources()
                                        .getDisplayMetrics()));//圆角 ： 默认为10dp
        mBorderRadiusTopLeft = a.getBoolean(
                R.styleable.RoundImageView_borderRadiusTopLeft, true);//圆角 ： 左上角
        mBorderRadiusTopRight = a.getBoolean(
                R.styleable.RoundImageView_borderRadiusTopRight, true);//圆角 ： 右上角
        mBorderRadiusBottomLeft = a.getBoolean(
                R.styleable.RoundImageView_borderRadiusBottomLeft, true);//圆角 ： 左下角
        mBorderRadiusBottomRight = a.getBoolean(
...
//        LogUtil.e("TAG", "onDraw");
    ...
    public void setType(int type) {
        if (this.type != type) {
            this.type = type;
            if (this.type != TYPE_ROUND && this.type != TYPE_CIRCLE && type != TYPE_ROUND_Fix) {
