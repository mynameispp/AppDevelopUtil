package com.ffzxnet.developutil.ui.guide.code.core;
...
import com.ffzxnet.developutil.ui.guide.code.listener.AnimationListenerAdapter;
...
import com.ffzxnet.developutil.ui.guide.code.model.HighLight;
import com.ffzxnet.developutil.ui.guide.code.model.HighlightOptions;
import com.ffzxnet.developutil.ui.guide.code.model.RelativeGuide;
            ...
            if (viewIds != null && viewIds.length > 0) {
                for (int viewId : viewIds) {
                    ...
                    if (click != null) {
                        ...
                        LogUtil.e(NewbieGuide.TAG, "can't find the view by id : " + viewId + " which used to remove guide page");
                    }
                }
            }
