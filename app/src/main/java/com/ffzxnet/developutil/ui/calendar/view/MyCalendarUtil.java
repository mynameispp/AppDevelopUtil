...
public class MyCalendarUtil extends CalendarUtil {
    ...
    public static List<String> getHolidayList() {
        return MyHolidayUtil.holidayList;
    }

    public static List<String> getWorkdayList() {
        return MyHolidayUtil.workdayList;
    }
    ...
    public static CalendarDate getCalendarDate(LocalDate localDate) {
        ...
        calendarDate.solarHoliday = MyHolidayUtil.getSolarHoliday(solarYear, solarMonth, solarDay);
        calendarDate.lunarHoliday = MyHolidayUtil.getLunarHoliday(lunar, nextLunar);
