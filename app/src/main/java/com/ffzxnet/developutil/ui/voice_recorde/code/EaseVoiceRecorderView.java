...
import com.ffzxnet.developutil.ui.voice_recorde.code.audio.AudioRecorder;
...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.my_widget_voice_recorder, this);
        ...
        wakeLock = ((PowerManager) Objects.requireNonNull(context.getSystemService(Context.POWER_SERVICE))).newWakeLock(
                PowerManager.SCREEN_DIM_WAKE_LOCK, "deviceUtil");
    }
