...
public class SecondFragmentAdapter extends BaseRVListAdapter<FirstTestBean> implements View.OnClickListener {
    ...
    public SecondFragmentAdapter(List<FirstTestBean> datas, AdapterListen mAdapterListen) {
        super(datas);
