...
-keep public class [com.ffzxnet.developutil].R$*{
...
#---------------------------------与js互相调用的类------------------------
-keep public class com.ffzxnet.developutil.ui.web.WebViewActivity{ *; }
#支付宝支付
...
-keepattributes *Annotation*
#---------------------------------实体类---------------------------------
-keep class [com.ffzxnet.developutil].** { *; }
...
-keep class cn.jpush.** { *; }
#---------------------------------自定义View的类------------------------
-keep class com.ffzxnet.developutil.utils.** {*;}
